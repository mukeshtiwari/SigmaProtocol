From Stdlib Require Integral_domain.
Require Fiat.Algebra.Nsatz.
Require Import Fiat.Util.Factorize.
Require Import Fiat.Algebra.Hierarchy Fiat.Algebra.Ring.
