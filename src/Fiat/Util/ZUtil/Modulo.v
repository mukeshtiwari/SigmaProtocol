...
Require Import Fiat.Util.ZUtil.ZSimplify.Core.
Require Import Fiat.Util.ZUtil.Tactics.DivModToQuotRem.
Require Import Fiat.Util.ZUtil.Tactics.LtbToLt.
Require Import Fiat.Util.ZUtil.Tactics.ReplaceNegWithPos.
Require Import Fiat.Util.ZUtil.Tactics.PullPush.Modulo.
Require Import Fiat.Util.ZUtil.Div.
Require Import Fiat.Util.ZUtil.Divide.
Require Import Fiat.Util.Tactics.BreakMatch.
Require Import Fiat.Util.Tactics.DestructHead.
...
#[global]
  ...
  Proof. apply Z.mod_mod_divide; exists b; ring. Qed.
