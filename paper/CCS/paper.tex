...
any list of talliers $\mathit{ts}$, and any published plaintext
...
certificate of the entire end-to-end verification. The related Rcoq proof can be accessed in the \href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Backend/HeliosTally.v}{\textcolor{green}{HeliosTally.v}} file.
...
\href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Examples/HeliosTallyIns.v}{\textcolor{green}{HeliosTallyIns.v}} file.


Finally, the \texttt{main.ml} file ties together the parser
...
expected by the Rocq formalisation. Once parsing is complete, \texttt{compute\_final\_count\_ins} is invoked
...
\textsc{Coqprime}~\cite{thery2007primality} library.  For $q$, the proof can be accessed from the \href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Examples/primeQ.v}{\textcolor{green}{primeQ.v}} file and 
for $p$, the proof can be accessed from \href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Examples/primeP.v}{\textcolor{green}{primeP.v}} file.  
