...
\todo{Adding a todo here because it's not good to have something like "Pedersen Linear Relation protocol" terms, and similar ones.

In fact, the protocol as is, in the current described situation, is trivial I would say. Therefore, reference Brands is not even that relevant.
Have to revise this section still before submitting...}
...
\todo{In actual voting systems, we would just reveal $\sum_{i=1}^{n} \ \alpha_i \cdot r_i$ to prove the linear relation, as part of the Tally protocol.}
...
This paper was edited for grammar using ChatGPT. \todo{Better omit this altogether, I mean the entire Acknowledgements section}
