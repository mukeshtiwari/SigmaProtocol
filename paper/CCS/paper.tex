...
\textcolor{red}{Berry: does the text below make sense?}
...
The implementation requires randomness of dimension $n + n(n-1) = n^2$ and produces proof transcripts of size $O(n^2)$, reflecting the quadratic nature of pairwise inequality constraints.
...
Our Rocq formalisation in [PedLinearRel.v](src/Crypto/PedLinearRel.v) implements this protocol 
