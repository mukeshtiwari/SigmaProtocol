...
$\left(x_i \cdot (x_i - x_j)^{-1}, (x_j - x_i)^{-1}\right)$ satisfy $(g_i \cdot g_j)^{x_i \cdot (x_i - x_j)^{-1}} \cdot (h_i \cdot h_j)^{(x_j - x_i)^{-1}}$ = $g_i^{x_i \cdot (x_i - x_j)^{-1}} \cdot g_j^{x_i \cdot (x_i - x_j)^{-1}} \cdot h_i^{(x_j - x_i)^{-1}} \cdot h_j^{(x_j - x_i)^{-1}}$ = $g_j$ after algebraic simplification using $h_i = g_i^{x_i}$ and $h_j = g_j^{x_j}$.
