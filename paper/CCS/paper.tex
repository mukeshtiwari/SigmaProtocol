...
Even though there exists many sigma protocols, the Schnorr protocol is used extensively in privacy-preserving voting systems, e.g, Helios, Belenios, SwissPost, etc. Therefore, 
...
certificate of the entire end-to-end verification. The related Rocq proof can be accessed in the \href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Backend/HeliosTally.v}{\textcolor{green}{HeliosTally.v}} file.
...
each ballot whether it was valid or invalid and, at the \texttt{finish}
...
changed, the verifier will detect the corruption. The source code can accessed 
from the \href{https://anonymous.4open.science/r/SigmaProtocol-EBA5/src/Executable/HeliosVerifiercode/main.ml}{\textcolor{green}{main.ml}} file.
